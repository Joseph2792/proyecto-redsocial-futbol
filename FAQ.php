...
?>
    ...
    <div class="cont-main-FAQ">
        <section class="col-sm-12 col-md-6">
            ...
            <div>
                <form action="get">
                    <div class="cont-search-faq">
                        <input type="search" placeholder="Escriba lo que desea buscar..." name="q" id="buscadorNav">
            ...
            <div class="accordion" id="accordionExample">
                ...
                <div class="card">
                    ...
                    <h5 class="mb-0">
                        ...
                        Como publicar un evento tipo campeonato
                        </button>
                    </h5>
                    </div>
